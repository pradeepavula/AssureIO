                ...
                <div className="items-center gap-x-12 lg:flex">
                    ...
                    <div className="max-w-xl mt-6 md:mt-0 lg:max-w-2xl">
                        ...
                        <p className="mt-3 text-gray-600">
                            AssureIO, specializes in datacenter operations, IT security, and desktop support to help businesses build resilient and scalable IT foundations. We prioritize our clients’ needs, maintain open communication, and encourage active collaboration to deliver tailored solutions that drive long-term success.
                        </p>
                        <NavLink
                            href="/get-started"
