      ...
      <div id="testimonials" className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-2xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-600">
            Listen to what experts around the world are saying about us.
          </p>
        </div>
        ...
        <div className="mt-12 relative">
          ...
          <button
            ...
            onClick={() => scroll("left")}
            className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white border shadow p-2 rounded-full hover:bg-gray-50"
          >
            {/* Left chevron (SVG) */}
          ...
          {/* Fading edges (optional, improves UX) */}
          ...
          >
            {testimonials.map((item, idx) => (
              <div
                key={idx}
                className="min-w-[350px] max-w-sm flex-shrink-0 bg-white border p-6 rounded-2xl shadow-sm"
              >
                <figure>
          ...
          <button
            ...
            className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white border shadow p-2 rounded-full hover:bg-gray-50"
          >
            {/* Right chevron (SVG) */}
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
